...
namespace Dropshot.WebServices {
	...
	public class ApplicationWebService : IApplicationWebServiceContract {
		...
		public ApplicationWebService() {
			...
			photonServers = JsonConvert.DeserializeObject<AuthenticateApplicationView>(Program.LoadEmbeddedJson("Dropshot.WebServices.Data.PhotonServers.json"));
			gameConfig = JsonConvert.DeserializeObject<ApplicationConfigurationView>(Program.LoadEmbeddedJson("Dropshot.WebServices.Data.ApplicationConfiguration.json"));
			mapData = JsonConvert.DeserializeObject<List<MapView>>(Program.LoadEmbeddedJson("Dropshot.WebServices.Data.Maps.json"));
		}
